...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="statics/logo2.jpg">
    ...
    <title>Welcome to World Bank</title>
...
<div id="container">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-black fixed fixed-top"
        style="font-family:candara; font-size:18px; box-shadow: 0px 0px 10px 0px black;">
        <div class="container-fluid">
            <a href="index.php"><img src="statics/logo2.jpg" alt=""
    ...
    <div class="container-large"
        style="color:white; height:500px; width: 100%; padding:8% 2% 2% 2%; background-color:#000000;">
        <div class="row">
            <div class="col" style="margin-left: 5%;">
                <br><br>&nbsp;<p class="zoomfont"
                    style="font-size:0px; text-shadow:3px 3px 3px grey; text-align:center;"><b>Welcome to <br>The<br>World
                        Bank!</b></p>
            </div>
            <div class="col" style="margin:2% 2% 2% 2%; text-align:center;">
                &nbsp;<img src="statics/fin.jpg" class="zoomin" alt="" style="width:0px;">
            </div>
        </div>
    </div>
    <img src="statics/abstbg6.png" alt="" style="width:100%; position:absolute; z-index:-1">
